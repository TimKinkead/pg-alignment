...
module.exports = function() {
    var a = [ {
        ...
        scores: [ {
            no: 1,
            description: "Template type uses a writing mode that does not match the intended purpose of the prompt."
        }, {
            no: 2,
            description: "Template task uses a writing mode that matches the intended purpose of the prompt."
        }, {
            no: 3,
            description: ""
        } ],
        ...
        scores: [ {
            no: 1,
            description: "Task purpose is overly broad or narrow."
        }, {
            no: 2,
            description: "Task purpose is focused."
        }, {
            no: 3,
            description: "Task is worded precisely to give students a clear and focused purpose for writing and unambiguous directions."
        } ],
        ...
        scores: [ {
            no: 1,
            description: "Prompt wording is unclear."
        }, {
            no: 2,
            description: "Prompt wording is clear."
        }, {
            no: 3,
            description: ""
        } ],
        ...
        scores: [ {
            no: 1,
            description: "Prompt wording, student background, or overview of the task biases students toward a particular response."
        }, {
            no: 2,
            description: "Prompt wording is unbiased, leaving room for diverse responses."
        }, {
            no: 3,
            description: ""
        } ],
        ...
        scores: [ {
            ...
            no: 2,
            description: "Prompt wording, content, texts, and writing product are aligned to task purpose (a good fit)."
        }, {
            no: 3,
            description: "Prompt, texts, content, and writing product are tightly aligned (are close to a perfect fit) to task purpose."
        } ],
        ...
        scores: [ {
            no: 1,
            description: "Task is answerable without using the texts or instructional scaffolding in module."
        }, {
            no: 2,
            description: "Task is text dependent, requiring students to go beyond prior knowledge to use evidence from the texts in their responses."
        }, {
            no: 3,
            description: ""
        } ],
        ...
        scores: [ {
            no: 1,
            description: "Background statement may not frame task for students."
        }, {
            no: 2,
            description: "Background statement frames task for students."
        }, {
            no: 3,
            description: ""
        } ],
        ...
        scores: [ {
            ...
            no: 3,
            description: "Task provides a pattern that can be used as a model to create other teaching tasks in the discipline."
        } ],
        ...
        scores: [ {
            no: 1,
            description: "Has a weak connection to content central to the discipline."
        }, {
            no: 2,
            description: "Addresses content central to the discipline and grade level CCSS reading standards, requiring students to build strong content knowledge."
        }, {
            no: 3,
            description: "Addresses big ideas or enduring understandings central to the discipline."
        } ],
        ...
        scores: [ {
            no: 1,
            description: "Oversimplifies a topic, OR does not require students to engage in analytic reading and thinking skills."
        }, {
            no: 2,
            description: "Engages students in a range of analytic reading and thinking skills."
        }, {
            no: 3,
            description: "Engages students in complex, higherorder thinking skills specific to the discipline."
        } ],
        ...
        scores: [ {
            no: 1,
            description: "Includes content or skill standards that are not relevant the task."
        }, {
            no: 2,
            description: ""
        }, {
        ...
        scores: [ {
            no: 1,
            description: "Are loosely aligned or misaligned to the purpose of the task."
        }, {
            no: 2,
            description: "Are useful for providing content and evidence to be used in addressing the task."
        }, {
            no: 3,
            description: "Are tightly aligned to the task purpose."
        } ],
        ...
        scores: [ {
            no: 1,
            description: "Bias students toward a particular response."
        }, {
            no: 2,
            description: "Do not bias students toward a particular response."
        }, {
            no: 3,
            description: ""
        } ],
        ...
        scores: [ {
            no: 1,
            description: "Are too difficult or too easy for the range of student ability."
        }, {
            no: 2,
            description: "Are accessible to most target students and appropriately complex, requiring them to apply grade level CCSS reading skills to comprehend and analyze content."
        }, {
            no: 3,
            description: "Are carefully selected, excerpted, or modified to provide texts with varied complexity (using either quantitative or qualitative measures) appropriate to students' reading ability."
        } ],
        ...
        scores: [ {
            no: 1,
            description: "Include so many texts or allow so much student choice that it will be difficult to support reading closely and provide appropriate instruction."
        }, {
            no: 2,
            description: ""
        }, {
        ...
        scores: [ {
            ...
            no: 3,
            description: "Are engaging, tightly relevant (indispensable), and authentic."
        } ],
        ...
        scores: [ {
            ...
            no: 3,
            description: "Represent central modes of discourse in the discipline."
        } ],
        ...
        scores: [ {
            no: 1,
            description: "Is inappropriate to the discipline, content, or challenge of the task."
        }, {
            no: 2,
            description: "Is appropriate for the discipline and content, and coherent with the purpose of the task."
        }, {
            no: 3,
            description: ""
        } ],
        ...
        scores: [ {
            no: 1,
            description: "Is too difficult or too easy for the range of student ability."
        }, {
            no: 2,
            description: "Is accessible to all students and intellectually challenging, requiring them to apply CCSS writing skills to demonstrate their content understanding and CCSS reading skills."
        }, {
            no: 3,
            description: ""
        } ],
        ...
        scores: [ {
            ...
            no: 3,
            description: "Authentically engages students in rhetorical modes and types of writing central to the discipline."
        } ],
        ...
        scores: [ {
            no: 1,
            description: "Skills list misses one or more significant demands of the task."
        }, {
            no: 2,
            description: "Skills list is relevant to teaching task, (including the task prompt, content, discipline, text(s), and writing product)."
        }, {
            no: 3,
            description: "Skills list is precise and tightly aligned to the task and the demands of the texts."
        } ],
        ...
        scores: [ {
            no: 1,
            description: "Skills are not clustered and sequenced to support the teaching task."
        }, {
            no: 2,
            description: "Skills are clustered and sequenced to support the teaching task."
        }, {
            no: 3,
            description: "Skills are clustered and sequenced to support access to the texts and completion of the teaching task product."
        } ],
        ...
        scores: [ {
            no: 1,
            description: "Skills list reflects the default skills list and includes skills that are not relevant to the teaching task."
        }, {
            no: 2,
            description: "Skills list includes gradelevel appropriate reading, writing, and thinking skills."
        }, {
            no: 3,
            description: ""
        } ],
        ...
        scores: [ {
            no: 1,
            description: "Some minitasks (product, prompt, and scoring guide) do not relate to skills list."
        }, {
            no: 2,
            description: "Minitasks (product, prompt, and scoring guide) relate to skills list."
        }, {
            no: 3,
            description: "Minitasks and instructional strategies are coherent, tightly aligned to the skills, and well designed to support student success on the teaching task."
        } ],
        ...
        scores: [ {
            no: 1,
            description: "Minitasks rely on general strategies that provide weak support for the skills, texts, and teaching task OR provide too much support, removing any challenge for students."
        }, {
            no: 2,
            description: "Minitasks support the teaching task (including the prompt, content, discipline, text(s), and writing product)."
        }, {
            no: 3,
            description: "Minitasks and instructional strategies are coherent, tightly aligned to the skills, and well designed to support student success on the teaching task."
        } ],
        ...
        scores: [ {
            no: 1,
            description: "Instructional strategies are loosely connected to minitasks and completion of the teaching task."
        }, {
            no: 2,
            description: "Instructional strategies support the minitasks and completion of the teaching task, (and are aligned to prompt, content, discipline, text(s), and writing product)."
        }, {
            no: 3,
            description: ""
        } ],
        ...
        scores: [ {
            ...
            no: 2,
            description: "Minitasks and instructional strategies provide opportunities for students to learn specified grade level CCSS reading, writing, and thinking skills."
        }, {
            no: 3,
            description: "Minitasks and instructional strategies explicitly build student capacity to apply disciplinespecific literacy skills to complex texts."
        } ],
        ...
        scores: [ {
            ...
            no: 3,
            description: "Minitasks and instructional strategies explicitly build student capacity to produce clear and coherent writing appropriate to discipline, task, purpose, and audience."
        } ],
        ...
        scores: [ {
            no: 1,
            description: "Pacing is not realistic."
        }, {
            no: 2,
            description: "Pacing is realistic."
        }, {
            no: 3,
            description: ""
        } ],
        ...
        scores: [ {
            no: 1,
            description: "Materials, references, and supports used in instruction are not available to other teachers."
        }, {
            no: 2,
            description: "Materials, references, and instructional strategies are included, linked, or cited in enough detail to allow other teachers to obtain them."
        }, {
            no: 3,
            description: "Materials, references, and instructional strategies are high quality, customized to the purpose of the teaching task, and described in enough detail for another teacher to use them."
        } ],
        ...
        scores: [ {
            no: 1,
            description: "Module does not present adequate opportunity to teach writing in response to reading."
        }, {
            no: 2,
            description: ""
        }, {
        ...
        scores: [ {
            ...
            no: 3,
            description: "Minitasks are well placed to provide formative feedback and give evidence about student progress."
        } ],
        azureStudio: "",
        apiKey: "",
        apiDocs: "",
        ...
        scores: [ {
            ...
            no: 3,
            description: "Scoring guides for minitasks include clear criteria aligned to the skill being taught."
        } ],
        azureStudio: "",
        apiKey: "",
        apiDocs: "",
        ...
        scores: [ {
            ...
            no: 3,
            description: "Texts, minitasks, or instructional strategies are differentiated for diverse learners."
        } ],
        azureStudio: "",
        apiKey: "",
        apiDocs: "",
        ...
        scores: [ {
            no: 1,
            description: "No student work samples are included."
        }, {
            no: 2,
            description: "Student work samples are included."
        }, {
            no: 3,
            description: "Student work samples representing different score levels are included, with scored rubrics."
        } ],
        azureStudio: "",
        apiKey: "",
        apiDocs: "",
    ...
    return a.forEach(function(a) {
        if (a && a.id) {
            var e = a.id.slice(0, 2), f = a.id.slice(0, 3);
            a.holisticCategory = b[e], a.indicatorCategory = c[f], a.guidingQuestion = d[f];
        }
    }), a;
}();